...
names(df) <- c("Fichero", "DISTRITOS", "RELACIONADAS_CON_LAS_PERSONAS", "RELACIONADAS_CON_EL_PATRIMONIO","POR_TENENCIA_DE_ARMAS","POR_TENENCIA_DE_DROGAS", "POR_CONSUMO_DE_DROGAS", "fecha", "codigo")
